  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-success-500/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <a
                href="#contact"
                className="bg-accent-600 hover:bg-accent-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg inline-flex items-center gap-2"
              >
                <Send size={20} />
                Get In Touch
              </a>
